...
/*
    Main Class is the entry point for the Application, which extends Application Class and calls the start() method.
 */
public class Main extends Application implements Serializable {
    ...
    /*
        Handles all ClickHandler methods in the Login View.
     */
    ...
    /*
    Click handler for adding a user under the adminView.
     */
    ...
    /*
    Switches the scene to a specified scene value.
     */
    ...
    /*
    Checks if the user already exists in a UserSession
     */
